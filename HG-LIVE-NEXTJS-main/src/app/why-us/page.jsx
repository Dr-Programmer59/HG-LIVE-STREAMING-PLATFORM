    ...
    return (
        <>
            <section className="text-gray-600 body-font">
                <h2 className="main-heading mt-10">
                    Why HG Vibe Live ?
                </h2>
                <div className="max-w-[70rem] px-5 py-24 pt-10 mx-auto">
            ...
            <section className="px-5 py-20">
                <div className="max-w-[80rem]  mx-auto flex flex-col md:flex-row gap-5 relative justify-center items-center">
                    <div className='w-[50%]'>
                        ...
                        <button type='submit' className='bg-primary text-white text-lg py-2 px-6 rounded'>Try For Free</button>
                    </div>
                    <div className="w-[50%] relative" initial={{ x: '100%', opacity: 0 }} whileInView={{ x: 0, opacity: 1 }}>
