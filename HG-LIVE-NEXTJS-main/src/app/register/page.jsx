...
import { login, register, verifyOTP } from '@/lib/actions/user'
...
const page = () => {
    ...
    const [preferred_streaming_schedule, setpreferred_streaming_schedule] = useState('');
    const [audience_size, setaudience_size] = useState('');
    const [streaming_equipment, setstreaming_equipment] = useState('');
    ...
    const submitHandler = async (e) => {
        ...
        formData.append('preferred_streaming_schedule', preferred_streaming_schedule);
        formData.append('audience_size', audience_size);
        formData.append('streaming_equipment', streaming_equipment);
        formData.append('additional_comments', additional_comments);
        if (file) formData.append('file', file);

        if (!agree) return toast.error('accept terms and conditions');
    ...
    const OTPSubmitHandler = async (e) => {
        e.preventDefault();
        let res = await dispatch(verifyOTP(OTP));
            ...
            {!dialogOpen ? (
                <>
                    {page == 'form' ?
                            ...
                            <div className='container m-auto flex justify-center items-center'>
                                <div className='w-[50rem] max-w-[50rem] border-[.2rem] border-primary rounded-[2.8rem] px-8 py-3'>
                                    ...
                                    <form className='p-1' onSubmit={submitHandler}>
                                        ...
                                        <MdModeEditOutline size={20} />
                                            ...
                                            <button onClick={() => fileRef.current.click()} type='button' className='py-2 px-4 bg-gray-50 rounded-md text-black/80 hover:bg-gray-100 '>
                                                Select Image to Upload
                                            </button>
                                        </div>
                                        <input type='file' id='file' ref={fileRef} className='hidden' onChange={fileChangeHandler} />

                                        {/* <div className='input-group flex flex-col gap-3 my-3 mx-4'>
                                <div className='flex items-center'>
                                    <input type='radio' name='role' value={'streamer'} checked={role == 'streamer'} onChange={(e) => setRole(e.target.value)} />
                                    <p className='text-black/90 ml-2'>I am streamer</p>
                                </div>
                                <div className='flex items-center'>
                                    <input type='radio' name='role' value={'other'} checked={role == 'other'} onChange={(e) => setRole(e.target.value)} />
                                    <p className='text-black/90 ml-2'>I am a church/business </p>
                                </div>
                            </div> */}

                                        {/* <div className='input-group flex flex-col m-3 mb-6'>
                                        <label htmlFor="organization_website" className='text-lg mb-1'>I am a</label>
                                        <select type='text' id='channel-name' name='channel-name' className='outline-none border-2 border-primary rounded-lg bg-transparent py-3 px-2' value={role} onChange={(e) => setRole(e.target.value)}>
                                            <option value="church/business/organization">Church/Business/Organization</option>
                                            <option value="user/streamer">User/Streamer</option>
                                        </select>
                                    </div> */}
                                        ...
                                        <div className='input-group flex flex-col m-3 mb-6'>
                                            <label htmlFor="phone_number" className='text-lg mb-1'>Phone Number</label>
                                            <input type='tel' name='phone_number' id='phone_number' placeholder='Enter Your Phone Number' className='outline-none border-2 border-primary rounded-lg bg-transparent py-3 px-2' value={phone} onChange={(e) => setPhone(e.target.value)} required />
                                        </div>
                                        {
                                            role == 'church/business/organization' &&
                                            <>
                                                <div className='input-group flex flex-col m-3 mb-6'>
                                                    <label htmlFor="address" className='text-lg mb-1'>Address</label>
                                                    <input type='text' name='address' id='address' placeholder='Enter Your address' className='outline-none border-2 border-primary rounded-lg bg-transparent py-3 px-2' value={address} onChange={(e) => setAddress(e.target.value)} required />
                                                </div>
                                                <div className='input-group flex flex-col m-3 mb-6'>
                                                    <label htmlFor="organization" className='text-lg mb-1'>Organization/Church Name</label>
                                                    <input type='text' name='organization' id='organization' placeholder='Enter Your Organization' className='outline-none border-2 border-primary rounded-lg bg-transparent py-3 px-2' value={organizationName} onChange={(e) => setOrganizationName(e.target.value)} required />
                                                </div>

                                                <div className='input-group flex flex-col m-3 mb-6'>
                                                    <label htmlFor="organization" className='text-lg mb-1'>Role/Position</label>
                                                    <input type='text' name='role' id='role' placeholder='Enter Your Role' className='outline-none border-2 border-primary rounded-lg bg-transparent py-3 px-2' value={position} onChange={(e) => setPosition(e.target.value)} required />
                                                </div>

                                                <div className='input-group flex flex-col m-3 mb-6'>
                                                    <label htmlFor="organization_website" className='text-lg mb-1'>Organization/website (optional)</label>
                                                    <input type='text' name='organization_website' id='organization_website' placeholder='Enter Your Organization Website' className='outline-none border-2 border-primary rounded-lg bg-transparent py-3 px-2' value={website} onChange={(e) => setWebsite(e.target.value)} />
                                                </div>


                                                <div className='input-group flex flex-col m-3 mb-6'>
                                                    <label htmlFor="organization_website" className='text-lg mb-1'>Organization Type</label>
                                                    <select type='text' id='channel-name' name='channel-name' placeholder='Enter Your Channel Name' className='outline-none border-2 border-primary rounded-lg bg-transparent py-3 px-2' value={organizationType} onChange={(e) => setOrganizationType(e.target.value)}>
                                                        ...
                                                        <option value="Cultural_Institution">Cultural Institution</option>
                                                ...
                                                <div className='input-group flex flex-col m-3 mb-6'>
                                                    <label htmlFor="preferred_streaming_schedule" className='text-lg mb-1'>Preferred Streaming Schedule</label>
                                                    <input type='text' name='preferred_streaming_schedule' id='preferred_streaming_schedule' placeholder='Enter Your Preferred Streaming Schedule' className='outline-none border-2 border-primary rounded-lg bg-transparent py-3 px-2' value={preferred_streaming_schedule} onChange={(e) => setpreferred_streaming_schedule(e.target.value)} />
                                                </div>

                                                <div className='input-group flex flex-col m-3 mb-6'>
                                                    <label htmlFor="audience_size" className='text-lg mb-1'>Audience Size</label>
                                                    <input type='text' name='audience_size' id='audience_size' placeholder='Enter Your Audience Size' className='outline-none border-2 border-primary rounded-lg bg-transparent py-3 px-2' value={audience_size} onChange={(e) => setaudience_size(e.target.value)} />
                                                </div>

                                                <div className='input-group flex flex-col m-3 mb-6'>
                                                    <label htmlFor="streaming_equipment  " className='text-lg mb-1'>Streaming Equipment</label>
                                                    <input type='text' name='streaming_equipment' id='streaming_equipment' placeholder='Enter Your Streaming Equipment' className='outline-none border-2 border-primary rounded-lg bg-transparent py-3 px-2' value={streaming_equipment} onChange={(e) => setstreaming_equipment(e.target.value)} />
                                                </div>

                                                <div className='input-group flex flex-col m-3 mb-6'>
                                                    <label htmlFor="additional_comments" className='text-lg mb-1'>Additional Comments/Requirements</label>
                                                    <input type='text' name='additional_comments' id='additional_comments' placeholder='Enter Your Additional Comments' className='outline-none border-2 border-primary rounded-lg bg-transparent py-3 px-2' value={additional_comments} onChange={(e) => setadditional_comments(e.target.value)} />
                                                </div>
                                        ...
                                        <div className='input-group flex flex-col m-3 mb-6'>
                                            <label htmlFor="dob" className='text-lg mb-1'>Date Of Birth</label>
                                            <input type='date' name='dob' id='dob' placeholder='Enter Your Additional Comments' className='outline-none border-2 border-primary rounded-lg bg-transparent py-3 px-2' value={dob} onChange={(e) => setDob(e.target.value)} />
                                        </div>
                                ...
                                <Link href={'/login'} className='text-primary text-sm'>Login In</Link>
                                        ...
                                        <div className='input-group flex flex-row gap-2 my-3 mx-4'>
                                            ...
                                            <Link href={'/terms-and-conditions'} className='text-black/90 underline'>Accept all Terms and Conditions</Link>
                                        </div>
                        ...
                        :
                        <OTPPage setOTP={setOTP} OTP={OTP} submitHandler={OTPSubmitHandler} />
                    }
                </>)
                :
                (
                    <div className='h-screen'>
                        <Dialog open={dialogOpen} onClose={() => toast.info("Please select role")}>
                            <form className='p-1 w-full h-full flex flex-col justify-center
                        '>
                                <h2 className='text-gray-800 text-2xl text-center mb-5'>Select Role</h2>
                                <div className='input-group flex flex-col m-3 mb-6'>
                                    <label htmlFor="organization_website" className='text-lg mb-1'>I am a</label>
                                    <select type='text' id='channel-name' name='channel-name' className='outline-none border-2 border-primary rounded-lg bg-transparent py-3 px-2' value={role} onChange={(e) => { setRole(e.target.value); setDialogOpen(false) }}>
